                    ...
                    <td align="center" valign="top" style="padding-bottom:30px;">
                        <table border="0" cellpadding="20" cellspacing="0" width="90%" id="emailBody" valign="top">
                            ...
                            <tr>
                                <td>
                                      <p>Dear {{ $data['name'] }}, </p>
                                    <p>This email is to advise you that your  submitted withdrawal has  approved and is on its way to your nominated account.</p>
                            ...
                            <tr>
                                <td>
                                     <p>To check the status of your withdrawal, please visit the "Withdrawal" page or lower section of the Dashboard Area and the "History" page to see details of previous withdrawals.</p>
